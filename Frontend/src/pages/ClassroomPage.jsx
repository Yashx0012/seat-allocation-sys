              ...
              <div className="flex flex-col h-full">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="space-y-2">
                            ...
                            <Input value={roomData.name} onChange={e => setRoomData({...roomData, name: e.target.value})} placeholder="Room name" />
                          </div>
                          <div className="space-y-2">
                            <Label>Rows</Label>
                            <Input type="number" value={roomData.rows} onChange={e => setRoomData({...roomData, rows: parseInt(e.target.value)||1})} />
                          </div>
                          <div className="space-y-2">
                            <Label>Columns</Label>
                            <Input type="number" value={roomData.cols} onChange={e => setRoomData({...roomData, cols: parseInt(e.target.value)||1})} />
                          </div>
                          <div className="space-y-2">
                            <Label>Block Width</Label>
                            <Input type="number" value={roomData.block_width} onChange={e => setRoomData({...roomData, block_width: parseInt(e.target.value)||1})} />
                          </div>
                      </div>
                 ...
                 <div className="flex-1 overflow-auto p-8 flex items-center justify-center bg-gray-50 dark:bg-[#050505]">
                    <div className="relative">
                        ...
                        <div className="grid gap-2 transition-all duration-300" style={{ gridTemplateColumns: `repeat(${roomData.cols}, minmax(45px, 1fr))` }}>

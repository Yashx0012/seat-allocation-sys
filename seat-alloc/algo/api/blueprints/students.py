...
def upload_students():
    ...
    try:
        ...
        # Get absolute path relative to current module to avoid hardcoded 'algo' strings when isolated
        base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        temp_dir = os.path.join(base_dir, 'cache', 'temp_uploads', str(user_id))
...
def commit_upload():
    ...
    try:
        ...
        base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        temp_file = os.path.join(base_dir, 'cache', 'temp_uploads', str(user_id), f"{batch_id}.json")
